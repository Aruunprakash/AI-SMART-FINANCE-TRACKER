plugins {
    ...
    id("kotlin-kapt")
    // Processes google-services.json into resources. Without this, Firebase is
    // never initialised and FirebaseAuth.getInstance() throws at runtime.
...
dependencies {
    ...
    // Networking (calls the FastAPI server in /server)
